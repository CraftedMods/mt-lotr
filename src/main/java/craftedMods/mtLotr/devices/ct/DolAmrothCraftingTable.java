...
@ZenClass(value = "mods.lotr.ct.dolAmroth")
public class DolAmrothCraftingTable extends FactionCraftingTable
{

    private static final DolAmrothCraftingTable instance;

    static
    {
        instance = new DolAmrothCraftingTable ();
    }

    protected DolAmrothCraftingTable ()
    {
        super (LOTRRecipes.dolAmrothRecipes);
    }
