...
@ZenClass(value = "mods.lotr.ct.moredain")
public class MoredainCraftingTable extends FactionCraftingTable
{

    private static final MoredainCraftingTable instance;

    static
    {
        instance = new MoredainCraftingTable ();
    }

    protected MoredainCraftingTable ()
    {
        super (LOTRRecipes.moredainRecipes);
    }
