...
@ZenClass(value = "mods.lotr.ct.dorwinion")
public class DorwinionCraftingTable extends FactionCraftingTable
{

    private static final DorwinionCraftingTable instance;

    static
    {
        instance = new DorwinionCraftingTable ();
    }

    protected DorwinionCraftingTable ()
    {
        super (LOTRRecipes.dorwinionRecipes);
    }
