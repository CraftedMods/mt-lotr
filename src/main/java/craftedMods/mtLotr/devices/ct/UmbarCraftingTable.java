...
@ZenClass(value = "mods.lotr.ct.umbar")
public class UmbarCraftingTable extends FactionCraftingTable
{

    private static final UmbarCraftingTable instance;

    static
    {
        instance = new UmbarCraftingTable ();
    }

    protected UmbarCraftingTable ()
    {
        super (LOTRRecipes.umbarRecipes);
    }
