...
@ZenClass(value = "mods.lotr.ct.nearHarad")
public class NearHaradCraftingTable extends FactionCraftingTable
{

    private static final NearHaradCraftingTable instance;

    static
    {
        instance = new NearHaradCraftingTable ();
    }

    protected NearHaradCraftingTable ()
    {
        super (LOTRRecipes.nearHaradRecipes);
    }
