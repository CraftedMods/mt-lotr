...
@ZenClass(value = "mods.lotr.ct.dunland")
public class DunlendingCraftingTable extends FactionCraftingTable
{

    private static final DunlendingCraftingTable instance;

    static
    {
        instance = new DunlendingCraftingTable ();
    }

    protected DunlendingCraftingTable ()
    {
        super (LOTRRecipes.dunlendingRecipes);
    }
