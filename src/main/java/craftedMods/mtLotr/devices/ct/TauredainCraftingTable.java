...
@ZenClass(value = "mods.lotr.ct.tauredain")
public class TauredainCraftingTable extends FactionCraftingTable
{

    private static final TauredainCraftingTable instance;

    static
    {
        instance = new TauredainCraftingTable ();
    }

    protected TauredainCraftingTable ()
    {
        super (LOTRRecipes.tauredainRecipes);
    }
