...
@ZenClass(value = "mods.lotr.ct.lothlorien")
public class GaladhrimCraftingTable extends FactionCraftingTable
{

    private static final GaladhrimCraftingTable instance;

    static
    {
        instance = new GaladhrimCraftingTable ();
    }

    protected GaladhrimCraftingTable ()
    {
        super (LOTRRecipes.elvenRecipes);
    }
