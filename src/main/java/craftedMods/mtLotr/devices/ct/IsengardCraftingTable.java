...
@ZenClass(value = "mods.lotr.ct.isengard")
public class IsengardCraftingTable extends FactionCraftingTable
{

    private static final IsengardCraftingTable instance;

    static
    {
        instance = new IsengardCraftingTable ();
    }

    protected IsengardCraftingTable ()
    {
        super (LOTRRecipes.urukRecipes);
    }
