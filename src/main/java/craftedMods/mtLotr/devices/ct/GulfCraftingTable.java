...
@ZenClass(value = "mods.lotr.ct.gulf")
public class GulfCraftingTable extends FactionCraftingTable
{

    private static final GulfCraftingTable instance;

    static
    {
        instance = new GulfCraftingTable ();
    }

    protected GulfCraftingTable ()
    {
        super (LOTRRecipes.gulfRecipes);
    }
