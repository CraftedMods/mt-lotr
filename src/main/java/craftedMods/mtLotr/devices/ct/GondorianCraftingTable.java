...
public class GondorianCraftingTable extends FactionCraftingTable
{

    private static final GondorianCraftingTable instance;

    static
    {
        instance = new GondorianCraftingTable ();
    }

    protected GondorianCraftingTable ()
    {
        super (LOTRRecipes.gondorianRecipes);
    }
