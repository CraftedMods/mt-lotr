...
@ZenClass(value = "mods.lotr.ct.blueDwarves")
public class BlueDwarvenCraftingTable extends FactionCraftingTable
{

    private static final BlueDwarvenCraftingTable instance;

    static
    {
        instance = new BlueDwarvenCraftingTable ();
    }

    protected BlueDwarvenCraftingTable ()
    {
        super (LOTRRecipes.blueMountainsRecipes);
    }
