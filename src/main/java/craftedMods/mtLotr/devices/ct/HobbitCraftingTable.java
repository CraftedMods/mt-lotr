...
@ZenClass(value = "mods.lotr.ct.hobbits")
public class HobbitCraftingTable extends FactionCraftingTable
{

    private static final HobbitCraftingTable instance;

    static
    {
        instance = new HobbitCraftingTable ();
    }

    protected HobbitCraftingTable ()
    {
        super (LOTRRecipes.hobbitRecipes);
    }
