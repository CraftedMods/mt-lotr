...
@ZenClass(value = "mods.lotr.ct.dale")
public class DaleCraftingTable extends FactionCraftingTable
{

    private static final DaleCraftingTable instance;

    static
    {
        instance = new DaleCraftingTable ();
    }

    protected DaleCraftingTable ()
    {
        super (LOTRRecipes.daleRecipes);
    }
