...
@ZenClass(value = "mods.lotr.ct.rivendell")
public class RivendellCraftingTable extends FactionCraftingTable
{

    private static final RivendellCraftingTable instance;

    static
    {
        instance = new RivendellCraftingTable ();
    }

    protected RivendellCraftingTable ()
    {
        super (LOTRRecipes.rivendellRecipes);
    }
