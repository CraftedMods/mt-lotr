...
@ZenClass(value = "mods.lotr.ct.highElves")
public class HighElvenCraftingTable extends FactionCraftingTable
{

    private static final HighElvenCraftingTable instance;

    static
    {
        instance = new HighElvenCraftingTable ();
    }

    protected HighElvenCraftingTable ()
    {
        super (LOTRRecipes.highElvenRecipes);
    }
