...
@ZenClass(value = "mods.lotr.ct.gundabad")
public class GundabadCraftingTable extends FactionCraftingTable
{

    private static final GundabadCraftingTable instance;

    static
    {
        instance = new GundabadCraftingTable ();
    }

    protected GundabadCraftingTable ()
    {
        super (LOTRRecipes.gundabadRecipes);
    }
